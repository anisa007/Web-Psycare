		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="images/clinic_04.jpg" alt="IMG">
				</div>

				<form method = "post" autocomplete = "on" action="signUp.php" class="login100-form validate-form">
...
<?php
    $con=mysqli_connect("localhost", "root","") or die(mysqli_error($con)); //Connect to server
      if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        mysqli_select_db($con,"register") or die("Cannot connect to database"); //Connect to database
